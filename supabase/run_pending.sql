...
-- as of Phase 8. Run this ONCE in the SQL editor (Project > SQL Editor > New
...
-- + organizations.sql, in dependency order. Safe to run even if some of it
-- were already applied (every statement is idempotent: `if not exists`,
